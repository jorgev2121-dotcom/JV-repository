...
| PASTE-D-006 | 2026-08-15 | Desktop — "Investigate Claude Code se…" | **The single live block.** Supersedes D-005. Fix model, restart, pull repo, work WORK-QUEUE.md top to bottom — now including the OCR correction and the agreements audit. | ISSUED |

...
- **TRK-2026-1614 — a wrongly-minted duplicate for 14598 SW 110 St. ~~Recommend: TUS-25-1023 survives.~~ CORRECTED 2026-08-20 by the desktop's REGISTRY-9401b — my earlier "TUS-25-1023 survives" was WRONG.** The desktop found there are **TWO registry files**: the MASTER `Tracking-Registry.md` (ClaudeMemory, 13 dated backups, carries the merge rule L151) and this repo `TRK-REGISTRY.md` (newer but missing the master's rows). The **master** says the survivor is **TRK-2026-1283** (14598 Miguelez, "MASTER REFERENCE", active since 2026-07-03) — with TRK-2026-1424 (electrical sub-permit) and TUS-26-1041 (legacy tag) under it. **`TUS-25-1023` has ZERO hits in the master** — it's an unregistered folder tag holding 117 real files. **`TRK-2026-1614` also ZERO in the master.** Correct shape (owner-gated): **TRK-2026-1283 = survivor; FOLD in TUS-25-1023 (117 files) + TUS-26-1041 (5 files); VOID 1614.** It's a **FOLD not a dedup** — CAPSULES-9073g proved TUS-26-1041 and TUS-25-1023 have ZERO file overlap, so nothing is redundant and nothing gets deleted on merge. **Awaiting Jorge.** This is also the root cause of 1614: a session reading only the repo file (which lacks 1283/1424/TUS-26-1041) concludes 14598 is unregistered and mints a new number.

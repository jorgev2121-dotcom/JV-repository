...
**One technical note, not urgent: your approvals board went quiet on its own for most of yesterday.** The file that mirrors your decision cards stopped refreshing for about 23 hours (last real update Wednesday night, still stale as of this report) — a scheduled task started failing and never recovered. Nothing was lost — the desktop's own day-by-day notes kept going the whole time — but if I told you a card count was unchanged yesterday, that may just be this mirror sitting frozen rather than nothing happening. Logged as RI-045 for tracking. No action needed from you; flagging so you know the numbers may catch up once it's running again.

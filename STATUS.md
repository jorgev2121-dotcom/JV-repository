...
- **The money review is essentially done *for the QuickBooks series* — but that is not the whole invoice
  ...
  page-by-page OCR re-audit confirmed the QuickBooks `\d{4}` list holds at **129 numbers** with nothing hidden.
  **⚠ 2026-08-24 correction (9655/9656/9657) — the "unknown payment" pile was double-counted and is now measured precisely:** the old "75 rows / $199,089.67 no-receipt-either-way" headline glued two populations together. The genuinely-unknown pile is **64 invoices / $118,727.60** (the other ~$80k was 2016 owner-workbook income whose status field never existed and is already reconciled, plus 11 rows / $12,160 Jorge himself marked paid in the wrong column). Time-barred per-invoice, **57 of those 64 are still LIVE (inside the 5-yr window) = $103,989.53**, and of the live set **43 invoices / $75,548.68 can ONLY be answered by the QuickBooks Online login** (they predate all bank data on the machine). **NONE of this is a proven receivable — it is "no receipt on the machine either way," and most were probably paid.** New win: invoice **6096 ($2,205, Iberostar Berkeley Shore) is now PROVEN PAID** — the payer wrote `INVOICE NO.: 6096` into the ACH wire (a bank-description channel nobody had read). The QuickBooks login (OD-22/OD-72/OD-73) is therefore worth **~$75k of unknowns to resolve, not $4,495**. **⚠ 2026-08-21 correction

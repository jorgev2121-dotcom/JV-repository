...
| TRK-2026-9073 | Build an orphan-onboarding SKILL | NOT_STARTED | Jorge's suggestion 2026-08-16. The procedure is stable and repetitive — a Skill stops every new session rediscovering it. Cloud can draft |
...
| TRK-2026-9076 | Schedule the 22 Miami-Dade sources on the desktop heartbeat | NOT_STARTED | **Cloud re-tested 2026-08-16: all four still 000 while github returns 400.** Chrome route is real but belongs to the desktop |
